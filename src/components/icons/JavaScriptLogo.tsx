...
/**
 * Renders the JavaScript logo as an SVG element.
 *
 * @param {object} props - The properties object for the JavaScriptLogo component.
 * @param {string} [props.color='#F7DF1E'] - The fill color of the logo. Defaults to yellow.
